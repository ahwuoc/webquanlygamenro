                        ...
                        <Link href="/boss/rewards">
                            <CardHeader>
                                <div className="flex items-center space-x-2">
                                    ...
                                    <CardTitle className="text-lg">Phần Thưởng</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent>
                                <CardDescription>Quản lý phần thưởng boss</CardDescription>
                            </CardContent>
                        </Link>
                    </Card>

                    <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                        <Link href="/boss/skills">
                            <CardHeader>
                                <div className="flex items-center space-x-2">
                            ...
                            <CardContent>
                                <CardDescription>Quản lý kỹ năng boss</CardDescription>
                            </CardContent>
                        </Link>
                    </Card>

                    <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                        <Link href="/boss/outfits">
                            <CardHeader>
                                <div className="flex items-center space-x-2">
                                    ...
                                    <CardTitle className="text-lg">Trang Phục</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent>
                                <CardDescription>Quản lý trang phục boss</CardDescription>
                            </CardContent>
                        </Link>
                    </Card>
                </div>
